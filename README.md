...
description: 'This is simple REST API, SQS and SNS example for AWS Lambda By Serverless framwork with TypeScript'
layout: Doc
framework: v1
platform: AWS
language: nodeJS
authorLink: 'https://github.com/muke5hy'
authorName: 'Mukesh Yadav'
authorAvatar: 'https://avatars0.githubusercontent.com/u/545172?s=460&u=4ceb21222adccbef33975e33970e033cdf3e9eaf&v=4'
-->

## NOTE: The code has been taken from https://github.com/serverless/examples
...
- SQS Reciver and sender
- SNS Reciver and sender
